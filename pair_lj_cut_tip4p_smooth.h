...
PairStyle(lj/cut/tip4p/smooth,PairLJCutTIP4PSmooth)

#else

#ifndef LMP_PAIR_LJ_CUT_TIP4P_SMOOTH_H
#define LMP_PAIR_LJ_CUT_TIP4P_SMOOTH_H

#include "pair.h"

namespace LAMMPS_NS {

class PairLJCutTIP4PSmooth : public Pair {
 public:
  PairLJCutTIP4PSmooth(class LAMMPS *);
  virtual ~PairLJCutTIP4PSmooth();
 ...
 protected:
  ...
  double cut_coul_inv,cut_coulsq_inv;
